                ...
                <form action="manage/furnServlet?action=add" method="post">
                    ...
                    <div class="table-content table-responsive cart-table-content">
                        <table>
                            ...
                            <tbody>
                            <%--老师多说一句 表单的各个字段，老师已经修改好了, 但是在实际工作中, 自己要确认清楚 --%>
                            <tr>
                                ...
                                <td class="product-name"><input name="name" style="width: 60%" type="text" value=""/>
                                </td>
                                <td class="product-name"><input name="maker" style="width: 90%" type="text" value=""/>
                                </td>
